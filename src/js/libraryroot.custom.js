...
async function isNewUserpanelLayout() {
    ...
    return getComputedStyle(userpanel).position === 'absolute';
}

// Sync Userpanel and Downloadbar width with Store sidebar (only relevant in new layout)
async function syncUserpanelWidth() {
